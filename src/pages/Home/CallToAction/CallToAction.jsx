...
const CallToAction = () => {
    return (
        <div className="px-3 lg:px-[5%] pt-28 lg:pt-36">
            <h2 className="text-5xl font-bold dark:text-white">Make a Difference Today!</h2>
